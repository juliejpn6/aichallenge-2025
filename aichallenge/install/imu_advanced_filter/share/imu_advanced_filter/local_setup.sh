...
: ${AMENT_CURRENT_PREFIX:="/aichallenge/install/imu_advanced_filter"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imu_advanced_filter/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imu_advanced_filter/environment/path.sh"
